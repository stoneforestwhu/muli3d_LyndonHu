...
CScene::CScene( IApplication *i_pParent )
{
	...
	SetAmbientLightColor( vector4( 0, 0, 0, 1 ) );     // 漫反射光源的颜色
...
HENTITY CScene::hCreateEntity( string i_sTypeName, bool i_bSceneProcess )  // i_bSceneProcess has default value = true
{
